...
class SuccessJson extends Response
{
    ...
    public function withPayload($data): SuccessJson
    {
        $new = clone $this;
        $new->setPayload($data);
    ...
    public function withEncodingOptions(int $encodingOptions): SuccessJson
    {
        $new                  = clone $this;
    ...
    private function updateBodyFor(SuccessJson $toUpdate): SuccessJson
    {
